import sys
from tip_calculator_as_functions import calculate_meal_costs, calculate_rate

def subtractor(a, b):
    # a and b are  parameters or arguments. add is the name of the function.
...
def function3(a=1, b=1):
    #You can assign default parameter values to me, which will be subbed in
...
def main(argv=sys.argv):
    # By convention, "main" defines a routine to be executed
